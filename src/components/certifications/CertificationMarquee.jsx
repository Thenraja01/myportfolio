...
export function CertificationMarquee({ certifications, onCardClick }) {
  ...
  return (
    <div className="w-full py-10 overflow-hidden relative group">
      ...
      <div className="absolute left-0 top-0 bottom-0 w-16 md:w-32 bg-slate-950 [mask-image:linear-gradient(to_right,black,transparent)] z-10 pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-16 md:w-32 bg-slate-950 [mask-image:linear-gradient(to_left,black,transparent)] z-10 pointer-events-none" />
